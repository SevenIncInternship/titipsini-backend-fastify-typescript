...
export const goodsSchema = z.object({
  ...
  paymentMethod: z.enum(["cash", "transfer"], "Payment method must be 'cash' or 'transfer'"),
  bank: z.enum(["bca", "bni", "bri", "mandiri"], "Bank must be 'bca', 'bni', 'bri', or 'mandiri'").optional(),
